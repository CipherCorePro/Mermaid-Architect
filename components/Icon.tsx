...
interface IconProps {
  type: 'folder' | 'file' | 'zip' | 'upload' | 'analyze' | 'fix' | 'png' | 'svg' | 'md' | 'spinner' | 'typescript' | 'javascript' | 'json' | 'markdown' | 'image' | 'css' | 'html' | 'settings' | 'render' | 'documentation' | 'whitepaper' | 'mockup' | 'manual' | 'scaffolding';
  className?: string;
}
